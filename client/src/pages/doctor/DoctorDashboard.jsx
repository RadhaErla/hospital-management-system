...
export const DoctorDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="p-6 sm:p-8 bg-gradient-to-r from-teal-800 via-brand-800 to-slate-900 rounded-3xl text-white shadow-xl shadow-teal-900/10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1.5">
          ...
          <p className="text-xs sm:text-sm text-slate-200 max-w-xl">
            Manage your daily appointment queue, patient consultations, prescriptions, and clinical records.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="p-5">
          ...
          <p className="text-[11px] text-slate-400 mt-0.5">Requires doctor review</p>
        </Card>
        ...
        <Card className="p-5">
          ...
          <p className="text-[11px] text-slate-400 mt-0.5">Visits completed</p>
        </Card>
        ...
        <Card className="p-5">
          ...
          <p className="text-[11px] text-slate-400 mt-0.5">Unique patients treated</p>
        </Card>
      </div>
